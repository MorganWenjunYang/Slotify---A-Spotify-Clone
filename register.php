<?php
  ...
  // remember the last value submitted
  ...
  <div id='background'>
    <div id = 'loginContainer'>
       <div id='inputContainer'>
         ...
         <form id='registerForm' action='register.php' method='POST'>
           ...
           <p>
             ...
             <input id='emailConfirm' name='emailConfirm' type='text' placeholder='e.g. bartSimpson@gmail.com' value="<?php getInputValue('emailConfirm')?>" required>
           </p>
           ...
           <p>
             ...
             <input id='passwordConfirm'  name='passwordConfirm' type='password'placeholder='Your Password' value="<?php getInputValue('passwordConfirm')?>" required>
           </p>
       ...
       <div id='loginText'>
         ...
         <h2>Listen to to loads of songs for free</h2>
         <ul>
